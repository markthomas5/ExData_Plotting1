...
#creates 4 plots showing different parameters from the data set
par(mfrow=c(2,2))
...
legend("topright", c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), col=c("Black", "Blue", "Red"),lty=1,bty="n")
